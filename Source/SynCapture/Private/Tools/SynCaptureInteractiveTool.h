...
#include "SynCaptureInteractiveTool.generated.h"
 ...
 */
UCLASS()
class SYNCAPTURE_API USynCaptureInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class SYNCAPTURE_API USynCaptureInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	USynCaptureInteractiveToolProperties();
 ...
 */
UCLASS()
class SYNCAPTURE_API USynCaptureInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<USynCaptureInteractiveToolProperties> Properties;
