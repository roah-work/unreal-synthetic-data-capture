...
#include "SynCaptureSimpleTool.h"
...
#define LOCTEXT_NAMESPACE "SynCaptureSimpleTool"

/*
 * ToolBuilder implementation
 */

UInteractiveTool* USynCaptureSimpleToolBuilder::BuildTool(const FToolBuilderState& SceneState) const
{
	USynCaptureSimpleTool* NewTool = NewObject<USynCaptureSimpleTool>(SceneState.ToolManager);
...
void USynCaptureSimpleTool::SetWorld(UWorld* World)
{
	this->TargetWorld = World;
}


void USynCaptureSimpleTool::Setup()
{
	USingleClickTool::Setup();

	Properties = NewObject<USynCaptureSimpleToolProperties>(this);
	AddToolPropertySource(Properties);
}


void USynCaptureSimpleTool::OnClicked(const FInputDeviceRay& ClickPos)
{
