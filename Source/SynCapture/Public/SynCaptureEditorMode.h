...
#include "SynCaptureEditorMode.generated.h"
 ...
 */
UCLASS()
class USynCaptureEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_SynCaptureEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	USynCaptureEditorMode();
	virtual ~USynCaptureEditorMode();
